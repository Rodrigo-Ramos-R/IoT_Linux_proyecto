...
#define MQTT_QOS_LEVEL 0     // 0 only in this minimal client
#endif

// NOTE: This minimal client assumes Remaining Length < 127 (1 byte).
// Keep your topic+payload small or extend Remaining Length handling if needed.
